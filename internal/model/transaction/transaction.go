...
type Transaction struct {
	ID          int64
	Type        string
	UserID      int64 `efactory:"User,users"`
	MainCategID int64 `efactory:"MainCateg,main_categories" eDB:"main_category_id"`
	SubCategID  int64 `efactory:"SubCateg,sub_categories" eDB:"sub_category_id"`
	Price       float64
	Note        string
	Date        time.Time
}
